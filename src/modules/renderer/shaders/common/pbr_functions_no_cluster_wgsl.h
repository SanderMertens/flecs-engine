#ifndef FLECS_ENGINE_SHADER_COMMON_PBR_FUNCTIONS_NO_CLUSTER_WGSL_H
#define FLECS_ENGINE_SHADER_COMMON_PBR_FUNCTIONS_NO_CLUSTER_WGSL_H

/* PBR functions without cluster-dependent point/spot lighting.
 * Used by the textured PBR shader which uses bind group 3 for textures. */
#define FLECS_ENGINE_SHADER_COMMON_PBR_FUNCTIONS_NO_CLUSTER_WGSL \
