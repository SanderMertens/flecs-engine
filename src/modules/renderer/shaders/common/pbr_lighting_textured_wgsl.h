#ifndef FLECS_ENGINE_SHADER_COMMON_PBR_LIGHTING_TEXTURED_WGSL_H
#define FLECS_ENGINE_SHADER_COMMON_PBR_LIGHTING_TEXTURED_WGSL_H

/* PBR lighting for textured batches. IBL, shadow, and cluster share
 * bind group 1; textures use bind group 2. */
#define FLECS_ENGINE_SHADER_COMMON_PBR_LIGHTING_TEXTURED_WGSL \
    "fn computePbrLightingTextured(\n" \
    "  albedo : vec3<f32>,\n" \
    "  metallic_raw : f32,\n" \
    "  roughness_raw : f32,\n" \
    "  emissive : vec3<f32>,\n" \
